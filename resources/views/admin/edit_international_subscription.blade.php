...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Edit International Package</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('base_on_service_lead', ['id' => $id]) }}">Subscription</a>
                        </li>
                        <li class="breadcrumb-item active">Edit International Package</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <form action="{{ route('edit_subscription', ['id' => $id]) }}" id="category_form_new"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="country" name="country[]" multiple="multiple" disabled>
                                        <option value="">Select country</option>
                                        @foreach ($country_data as $country)
                                        @if($country->id == '276')
                                        @continue
                                        @endif
                                           <option value="{{ $country->id }}" @if(in_array($country->id,$country_array)) {{ 'selected' }} @endif>{{ $country->country }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <span>
                                        <select class="form-control" id="continents" name="continents[]" multiple="multiple" 
                                            onchange="to_country_change();" disabled>
                                            <option value="">Select Continents</option>
                                            @foreach ($continents_data as $continent)
                                                <option value="{{ $continent->id }}" @if(in_array($continent->id,$continents_array)) {{ 'selected' }} @endif>{{ $continent->continent }}</option>
                                            @endforeach
                                        </select>
                                    </span>
                                    <p class="form-error-text" id="continents_error" style="color: red; margin-top: 10px;">
                                    </p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span id="to_country_chang">
                                        <select class="form-control" id="to_country" name="to_country[]"  multiple="multiple" disabled>
                                            <option value="">Select Moving to Country</option>
                                            @foreach ($country_data as $country)
                                                <option value="{{ $country->id }}" @if(in_array($country->id,$to_country_array)) {{ 'selected' }} @endif>{{ $country->country }}</option>
                                            @endforeach
                                        </select>
                                    </span>
                                    <p class="form-error-text" id="to_country_error" style="color: red; margin-top: 10px;">
                                    </p>
                                </div>
...
@section('footer_js')
    <script>
      $("#services").select2({
        ...
        $("#to_country").select2({
            placeholder: "Select a Moving to Country" // Replace with your desired placeholder text
        });
        $("#continents").select2({
            placeholder: "Select a Continents" // Replace with your desired placeholder text
        });
