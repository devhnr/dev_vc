            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form id="category_form" action="{{ route('help.update', $help->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
							@php
                                $selectedSubservices = is_array($help->subservice)
                                    ? $help->subservice
                                    : explode(',', $help->subservice);
                            @endphp
                                      ...
                                      <select class="form-control" id="packages" name="packages[]" multiple="multiple">
                                        ...
                                        @foreach ($allsubservices as $allsubservices_data)
                                            <option value="{{ $allsubservices_data->id }}"
                                                {{ in_array($allsubservices_data->id, $selectedSubservices) ? 'selected' : '' }}>
                                                {{ $allsubservices_data->subservicename }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="question" name="question" type="text" class="form-control"
                                        placeholder="Enter Question" value="{{ $help->question }}" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        placeholder="Enter Answer" value="{{ $help->answers }}" />
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a class="btn btn-primary" href="{{ route('help.index') }}"> Cancel</a>
...
@section('footer_js')
    ...
    <script>
        function faq_validation() {
            ...
            if (answer == '') {
                jQuery('#answer_error').html("Please Enter Answers");
