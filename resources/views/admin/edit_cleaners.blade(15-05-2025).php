...
<style type="text/css">
   ...
   <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Edit Cleaners</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('cleaners.index') }}">Cleaners</a></li>
                        <li class="breadcrumb-item active">Edit Cleaners</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('cleaners.update', $cleaners->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label for="name">Cleaner Description</label>
