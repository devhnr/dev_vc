                                ...
                                @endphp
                                   ...
                                   <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="type_of_subscription" style="width: 20%;display: inline-block;">
                                                    <label>
                                                        <input type="radio" name="type_of_subscription" id="radio_type" value="2" onclick="toggleDiv(this.value)"> Auto Accept Package
                                                    </label>
                                                </div>
