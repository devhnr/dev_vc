                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $package_inquiry_accepted = DB::table('package_inquiry_accepted')
                                                        // ->where('id',$package_inquiry_accepted->id)
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-center table-hover datatable" id="example">
                                    ...
                                    <tbody>
                                     ...
                                     @php
                                        // echo"<pre>";print_r($package_inquiry_accepted);echo"</pre>";exit;
                                     @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary"
                                                            href="{{ url('garden-enquiry-view', $packages_enquiry_data->id) }}">View Information</a>
                                                    </td>
