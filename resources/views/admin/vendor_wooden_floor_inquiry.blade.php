    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Wooden Floor Polishing Inquiry</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Wooden Floor Polishing Inquiry</li>
                    </ul>
                </div>
                <div class="col-auto">
                                ...
                                <table class="table table-center table-hover datatable" id="enqury_table">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Date</th>
                                            <th>Wooden Floor Polishing Inquiry No</th>
                                            <th>Name</th>
                                            <th>Service</th>
                                            <th>Sub Service</th>
                                            <th>Lead Info</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-primary"
                                                                    href="{{ url('wooden-enquiry-detail', $data->id) }}">View Information</a>
