                               ...
                               //echo "<pre>";print_r($resultArray);echo "</pre>";exit;
                                ...
                                foreach ($resultArray as $resultArray_data) {
                                    ...
                                    if($resultArray_data['type_of_package'] == '0'){
                                        ...
                                        $typeInquiry = "International Move";
                                    }
                                    ...
                                    foreach ($packages_enquiry as $packages_enquiry_da) {
                                        ...
                                        // echo "<pre>";print_r($country_from);echo "</pre>";
                                        // echo "<pre>";print_r($country_to);echo "</pre>";
                                                // exit;
                                    ...
                                    // echo "<pre>";print_r($subs_country_from);echo"</pre>";
                                    // echo "<pre>";print_r($subs_country_to);echo"</pre>";exit;
                                        ...
                                        // echo $packages_enquiry_type."<br>";
                                            if(in_array($country_id_to,$subs_country_to) && in_array($country_id_from,$subs_country_from) && isset($resultArray_data['type_of_package']) && 
