                                               ...
                                               @foreach ($painting_enquiry as $painting_data)
                                                   <tr>
                                                       ...
                                                       <td>{{ date('d-m-Y', strtotime($painting_data->added_date))}}</td>
                                                        <td>{{ $painting_data->inquiry_id }}</td>
                                                        <td>{{ $painting_data->type_of_painting }}</td>
                                                        <td>
                                                        ...
                                                        <td>{{ $painting_data->name ?? '' }}</td>
                                                        <td>{{ $painting_data->email ?? '' }}</td>
                                                        <td>{{ $painting_data->mobile ?? '' }}</td>
                                                        <td>
                                                            ...
                                                            <a class="btn btn-primary" href="javascript:void(0)" onclick="assign_vendor('{{$painting_data->id}}');">Assign Vendor</a>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a class="btn btn-primary" href="javascript:void(0)" onclick="email_to_vendor('{{$painting_data->id}}');">Email</a>
                                                        </td>
                                                        <td>    
                                                        <a class="btn btn-primary"
                                                            href="{{ url('painting-lead-detail', $painting_data->id) }}">View Information</a>
                                                    </td>
                                                   </tr>
                                                   @php
                                                       $i++;
...
<div class="modal custom-modal fade" id="assign_vendor_model" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="painting_vendor_form" action="{{ url('painting-vendor-form') }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="modal-body">
 ...
 <div class="modal custom-modal fade" id="email_vendor_model" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="painting_email_to_vendor" action="{{ url('painting-wallet-vendor') }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="modal-body">
                ...
                <p class="form-error-text" id="painting_email_vendor_id_error" style="color: red; margin-top: 10px;"></p>
            </div>
            <div class="modal-footer text-center">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
