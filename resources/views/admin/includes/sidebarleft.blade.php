    <div class="sidebar-inner slimscroll">
        ...
        <li class="submenu">
         <a href="#"
                class="{{ request()->segment(2) == 'order' || request()->segment(1) == 'cleaning_package_order' || request()->segment(1) == 'painting-service-order' || request()->segment(1) == 'handyman-service-order' || request()->segment(1) == 'salon-spa-order' || request()->segment(1) == 'pest-control-order' ||  request()->segment(3) == 'painting-detail' || request()->segment(1) == 'painting-service-admin-order'  || request()->segment(3) == 'moving-detail' || request()->segment(1) == 'moving-admin-order' || request()->segment(1) == 'salon-spa-admin-order' || request()->segment(3) == 'handyman-detail' || request()->segment(3) == 'salon-spa-detail' || request()->segment(3) == 'pest-control-detail' || request()->segment(3) == 'cleaning-detail' || request()->segment(1) == 'cleaning-admin-order' || request()->segment(2) == 'vendororder' || request()->segment(3) == 'vendor-moving-detail' || request()->segment(2) == 'cleaning-listing' || request()->segment(3) == 'vendor-cleaning-detail'|| request()->segment(2) == 'painting-listing' || request()->segment(3) == 'vendor-painting-detail' || request()->segment(2) == 'salon-spa-listing' || request()->segment(3) == 'vendor-salon-spa-detail' || request()->segment(2) == 'pest-control-listing' || request()->segment(3) == 'vendor-pest-control-detail'  || request()->segment(1) == 'pest-control-admin-order'  || request()->segment(1) == 'handyman-service-admin-order'  ||  request()->segment(2) == 'handyman-and-service-listing'  ? 'active' : '' }}">
                <i data-feather="pie-chart"></i> <span>Package Orders</span> <span class="menu-arrow"></span></a>
                <ul>
                ...
                @if (in_array('41', $permission1))
					...
					@endif
					@if(Auth::user()->vendor == 0)	
						<li class="{{ Route::currentRouteName() === 'painting-service-order' || Route::currentRouteName() === 'painting-detail'  || Route::currentRouteName() === 'painting-service-admin-order' ? 'active' : '' }}">
                ...
                @if (in_array('44', $permission1))
					...
					@endif
					@if(Auth::user()->vendor == 0)	
                        <li class="{{ Route::currentRouteName() === 'salon-spa-order' || Route::currentRouteName() === 'salon-spa-detail' || Route::currentRouteName() === 'salon-spa-admin-order' ? 'active' : '' }}">
                ...
                @if (in_array('45', $permission1))
                   @if(Auth::user()->vendor == 1)
					...
					@endif
					@if(Auth::user()->vendor == 0)
                        <li class="{{ Route::currentRouteName() === 'pest-control-order' || Route::currentRouteName() === 'pest-control-admin-order' || Route::currentRouteName() === 'pest-control-detail'  ? 'active' : '' }}">
                ...
                @if (in_array('42', $permission1))
					...
					@endif
                    @if(Auth::user()->vendor == 0)
                    <li class="{{ Route::currentRouteName() === 'handyman-service-order' || Route::currentRouteName() === 'handyman-service-admin-order' ||  Route::currentRouteName() === 'handyman-detail' ? 'active' : '' }}">
    ...
    @endif
        ...
        <li class="submenu">
         <a href="#"
                ...
                <i data-feather="pie-chart"></i> <span>Inspection Package</span> <span class="menu-arrow"></span></a>
                <ul>
