    ...
    <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
            ...
            @endif
                ...
                @endif --}}
                @if (in_array('19', $permission1))
                    <li class="{{ request()->segment(2) == 'order' && request()->segment(3) != 'painting-detail' ? 'active' : '' }}">
                    ...
                    <li class="{{ (request()->segment(1) == 'painting-service-order' || request()->segment(3) == 'painting-detail') ? 'active' : '' }}">

                        <a href="{{ route('painting-service-order') }}">
                           <i data-feather="clipboard"></i>
                           <span>Package Order - Painting</span>
                       </a>
                   </li>
