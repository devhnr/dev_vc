            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('driver.update', $driver->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <select class="form-control" id="user_id" name="user_id">
                                        ...
                                        @foreach ($user_category as $user_data)
                                            <option value="{{ $user_data->id }}" <?php if ($user_data->id == $driver->role_id) {
                                                echo 'selected';
                                            } ?>>{{ $user_data->cname }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="user_name" name="user_name" type="text" class="form-control"
                                        placeholder="Enter User Name" value="{{ $driver->user_name }}" />
                                         @error('user_name')
                                            <p class="form-error-text" style="color: red; margin-top: 10px;"> {{ $message }}</p>
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control"
                                        placeholder="Enter Email" value="{{ $driver->email }}" />
                                        @error('email')
                                            <p class="form-error-text" style="color: red; margin-top: 10px;"> {{ $message }}</p>
                                        @enderror
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a class="btn btn-primary" href="{{ route('driver.index') }}"> Cancel</a>
