            ...
            <div class="row align-items-center">
                ...
                @if (in_array('57', $edit_perm))
                    <div class="col-auto">
                        ...
                        <a class="btn btn-primary me-1" href="{{ route('model.create') }}">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('delete_model') }}" enctype="multipart/form-data">
                                        ...
                                        @foreach ($models as $data)
                                            <tr>
                                                <td><input name="selected[]" id="selected[]" value="{{ $data->id }}"
                                                 ...
                                                 <td>
                                                    {!!Helper::vehiclename($data->vehicle_name)!!}
                                                </td>
                                                ...
                                                @if (in_array('57', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('model.edit', $data->id) }}"><i
