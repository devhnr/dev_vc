    ...
    <ul class="splide__list">
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <a href="{{ url('service/pest-control-and-gardening')}}"><img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/pest_control_icon.png') }}" alt="" width="60px;"></a>
            </div>  
          </div>
          <div class="details">
                                        ...
                                        <li class="splide__slide">
                                            ...
                                            <div class="listing-style1">
                                                ...
                                                <div class="list-content">
                                                    <a class="d-flex align-items-center subservice-font" 
