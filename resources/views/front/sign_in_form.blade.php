            ...
            <div class="row wow fadeInRight" data-wow-delay="300ms">
                <div class="col-xl-6 mx-auto">
                    <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
                        ...
                        <div class="mb25">
                            <label class="form-label fw500 dark-color requiredStar">Your Name</label>
                        ...
                        <div class="mb15">
                            <label class="form-label fw500 dark-color requiredStar">Your Phone Number</label>
                        ...
                        <div class="mb25">
                            <label class="form-label fw500 dark-color requiredStar">Your Email</label>
                    ...
                    @endphp
                        ...
                        <div class="d-grid mb20">
                            ...
                            <button type="button" class="ud-btn btn-thm default-box-shadow2"
                                onclick="javascript:category_validation()" id="submit_button">Continue</button>
