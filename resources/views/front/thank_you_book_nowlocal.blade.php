...
<style>
	...
	@media only screen and (max-width: 768px) {
        ...
        if($payment_mode == 1){
			...
			$text1 = "Accepted payment methods include cash and card.";
        }else{
    ...
    @endphp
		...
		<section class="wow animate__fadeIn pt40 mt120">
			...
			<i class="fa-solid fa-check" style="font-size: 40px;margin: 0 0 3px 4px;"></i>
				...
				<p class="textp">Once confirmed, ensure that you are at the specified location and time to <br>receive your service.</p>
            </div>
        </section>
