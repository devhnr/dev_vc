                    ...
                    <div class="wow fadeInRight mb-3" data-wow-delay="300ms">
                        @if(isset($banner_subservices->banner_image))
                            ...
                            <div class="banner-content-center">
                                ...
                                class="ud-btn btn-thm2 add-joining custome-button mb-2 mb-md-0 me-md-3" id="get_quote_button">Get a Quote</a>
                               ...
                               {{-- <div class="d-flex flex-column flex-md-row justify-content-center align-items-center px-4 mt-4">
                                <a href="http://localhost/vendorcity_git/dev_vc/enquiry/30/23"
                                class="ud-btn btn-thm2 add-joining custome-button mb-2 mb-md-0 me-md-3">
                                    Get a Quote
                                </a>
                                <a href="#"
                                class="ud-btn btn-thm2 custome-button add-joining">
                                    Book Now
                                </a>
                                </div> --}}
                                @else
