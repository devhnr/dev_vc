...
<section class="our-about bgc-thm2  pb0 pt0 mb30 mt120 vendor_banner_sec mrgb0">
    <div>
        <div class="row align-items-center">
            ...
            <div class="col-xl-12">
                <div class="position-relative mb30-lg mrgb0 mobile_top">
                    <div class="wow fadeInRight mb-3" data-wow-delay="300ms">
                        @if(isset($banner_subservices->banner_image))
                            ...
                            <div class="banner-content-center">
                                <h2 class="banner_title text-white banner_static_title">Trusted home cleaning services in Dubai — reliable, affordable, and hassle-free.</h2>
                                <h6 class="text-white">
                                    Enjoy hassle-free home cleaning with our trusted professionals in Dubai. Whether it’s a quick tidy-up or a deep clean, we make sure your space shines.
                                </h6>

                                {{-- Buttons if needed --}}
                                @if($subservices_new->id == 23 || $subservices_new->id == 26)
                                <a href="#" class="ud-btn btn-thm2 custome-button add-joining me-2">Book Now</a>
                                @endif

                                @if($banner_subservices->is_bookable == 1)
                                <a href="{{ route('enquiry', ['service_id' => $services_id, 'subservice_id' => $subservices_new->id]) }}"
                                class="ud-btn btn-thm2 add-joining custome-button">Get a Quote</a>
                                @else
                 ...
                 <div class="col-sm-6 col-xl-3 col-6 col-lg-3">
                            ...
                            <a href="{{ url('package-lists/' . $services_data->page_url) }}">
                                @if (isset($services_data->image) && $services_data->image != '')
                                    <img class="w-100" src="{{ asset('public/upload/subservice/large/' . $services_data->image) }}" alt="">
                                @else
                                    <img class="w-100" src="{{ asset('public/upload/subservice/large/1715859524No_Image_Available.jpg') }}" alt="">
                                @endif
                            </a>
                        </div>
                       <div class="list-content">
...
<div id="scrollButton">
    @if($banner_subservices->is_bookable == 1 || $subservices_new->id == 47)
