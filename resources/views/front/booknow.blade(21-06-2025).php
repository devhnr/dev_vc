...
document.addEventListener('DOMContentLoaded', function () {
    new Splide('#select_your_cleaner_slider_spatie', {
        type: 'slide',
        perPage: 3,              // Show 3 full slides per view
        focus: 'center',         // Center the middle slide (enables partial edges on both sides)
        autoplay: false,
        pagination: false,
        arrows: false,
        stagePadding: 40,  
        breakpoints: {
            768: {
                fixedWidth:'45%',
                focus: 'center',
                stagePadding: 20, // Slightly smaller padding for smaller screens
            },
            480: {
                fixedWidth:'45%',
                focus: 'center',
                stagePadding: 20, // Adjust for smallest screen
            },
        },
    }).mount();
});
