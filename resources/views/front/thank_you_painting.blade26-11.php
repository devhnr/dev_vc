...
<style>
	...
	@media only screen and (max-width: 768px) {
		...
		//echo "<pre>";print_r($payment_mode);echo "</pre>";
		$text2 = "";
        if($payment_mode == 1){
            $text = "Your payment needs to be processed before our crew reaches the location.";
			$text1 = "You will receive a detailed invoice on your email address shared.";
			$text2 = "Accepted payment methods include Cash and Card.";
        }else{
            $text = "Your payment has been successfully processed online.";
			$text1 = "You will receive a detailed invoice shortly via email.";
        }
    @endphp
		...
		<section class="wow animate__fadeIn pt40 mt120">
			...
			<i class="fa-solid fa-check" style="font-size: 40px;margin: 0 0 3px 4px;"></i>
				...
				<p class="textp">
                    <b>{{ session('painting_service_name'); }}</b><br>
