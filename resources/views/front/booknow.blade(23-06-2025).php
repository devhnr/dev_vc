            ...
            <div class="col-lg-6 wow fadeInUp" data-  -delay="300ms">
                ...
                <div id="service-step-title" class="main-title">
                    ...
                    <h2 class="title step-title">
                        <span class="back-icon d-block d-md-none"></span> 
                        Service Details</h2>
...
<div class="modal modal-mobile-bottom" id="Learnmore_{{$subservice_id}}"  tabindex="-1" aria-labelledby="LearnmoreTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-bottom modal-lg" id="modal-digi" role="document">
      <div class="modal-content">
        <div class="modal-header" style="display:block;">
    ...
    function get_hide_show(id){
        ...
        if (id == 1) {
           ...
           if (window.innerWidth <= 767) {
            $(".step-title .back-icon").html('<i class="fas fa-arrow-left"></i>');
            ...
            $(".step-title .back-icon").empty(); // Remove icon on larger screens
        }
...
document.addEventListener('DOMContentLoaded', function () {
    if (window.innerWidth <= 767) {
        const stepText = document.querySelector('#service-step-title .step-p');
