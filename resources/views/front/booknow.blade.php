            ...
            success: function(msg) {
                ...
                if (response_ajax.status === 'success') {
                   ...
                   var percleanprice = (parseInt(calprice)) * no_of_cleaners;
                    ...
                    var crossprice_new = parseInt(sub_total) + 
                                        // parseInt(percleanprice_discount) + 
                                        // Math.round(additional_charge_discount) + 
                    ...
                    // alert(sub_total);
                    // alert(crossprice_discount);
                    // alert(additional_charge_discount);
...
for (let i = 0; i < daysToShow; i++) {
    ...
    dayDiv.addEventListener('click', function() {
        if (!dayDiv.classList.contains('disabled')) {
            ...
            if (formattedDate.day === 'Sa' || formattedDate.day === 'Su') {
