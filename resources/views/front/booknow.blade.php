...
<section class="our-register">
    <div class="container">
        ...
        <div class="col-lg-7">
                ...
                <div class="tab1">
                    ...
                    @if($subservice_id == 70 || $subservice_id == 71 || $subservice_id == 29 || $subservice_id == 72 || $subservice_id == 73 || $subservice_id == 79 || $subservice_id == 80 || $subservice_id == 81 || $subservice_id == 82 || $subservice_id == 83 || $subservice_id == 84 || $subservice_id == 85 || $subservice_id == 86 || $subservice_id == 87 || $subservice_id == 88 || $subservice_id == 52)
    ...
    <p class="form-error-text" id="cleaner_error" style="color: red; margin-top: 10px;"></p>
            ...
            @endif
                ...
                @if($subservice_id == 29 || $subservice_id == 70 || $subservice_id == 71 ||     $subservice_id == 72 || $subservice_id == 73 || $subservice_id == 79 || $subservice_id == 80 || $subservice_id == 81 || $subservice_id == 82 || $subservice_id == 83 || $subservice_id == 84 || $subservice_id == 85 || $subservice_id == 86 || $subservice_id == 87 || $subservice_id == 88 || $subservice_id == 52)
                    @php
                        $subtotal = 0;
                    @endphp
                            @if (Cart::count() > 0)
...
@if($subservice_id == 70 || $subservice_id == 29 || $subservice_id == 71 || $subservice_id == 72 || $subservice_id == 73 || $subservice_id == 79 || $subservice_id == 80 || $subservice_id == 81 || $subservice_id == 82 || $subservice_id == 83 || $subservice_id == 84 || $subservice_id == 85 || $subservice_id == 86 || $subservice_id == 87 || $subservice_id == 88 || $subservice_id == 52)
...
// alert(coupan_value);
    ...
    function get_hide_show(id){
        ...
        if($subservice_id == 29 || $subservice_id == 70 || $subservice_id == 71 || 
            ...
            $subservice_id == 86 || $subservice_id == 87 || $subservice_id == 88 || $subservice_id == 52){
            @endphp
