...
<section class="our-register">
    <div class="container">
        ...
        <div class="col-lg-6">
                ...
                <div class="tab1">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="hour_input items">
                            ...
                            <p style="font-size: 9px; margin:0 0 0 14px;">AED 
                    ...
                    <h5 class="font-weight-bold h3">About our {{ $subservice_name }} Service </h5>
                    ...
                    data-bs-target="#subservice_popup_{{$subservice_data->id}}">Read more </a>
                        ...
                        @if(!empty($package_cat))
                            ...
                            <div class="form-group mb-3" id="package-category-{{ $package_cat_data->id }}" >
                                ...
                                <div class="row align-items-center mobile-view">
                                    ...
                                    <div class="col-lg-9 mobile-furniture">
                                        <div class="package-data-div">
                                        <h5 style="margin: 0;">{{ $package_data->name }}</h5>
                                        <span> 
            ...
            <div class="tab2" style="display:none; min-height:1100px;">
            ...
            @if($user_id != "")
                @php
                $firstCleaner = DB::table('cleaners')
                ...
                $otherCleaners = DB::table('cleaners')
              ...
              <div class="form-group mb-3">
                    ...
                    <div class="radio-group owl-carousel owl-theme slider" id="select_your_cleaner">
                        ...
                        @foreach($cleaners as $data)  
                            <div class="cleaners-div" onclick="cleaner_data('{{$data->id}}','{{$data->name}}');">
                                <div class="items" >
                                    ...
                                    <input type="radio" id="cleaner" name="cleaner" class="cleaners-radio" value="{{$data->name}}" >
                                    ...
                                    <a style="cursor: pointer;" data-bs-toggle="modal" id="cleaner_description" data-bs-target="#cleaner_description_{{$data->id}}">
                                    <p class="cleaner-name">{{ $data->name }}</p></a>
                                    @if($data->id != 1)
                ...
                <p class="form-error-text" id="cleaner_error" style="color: red; margin-top: 10px;">
                </p>
            </div>
            @endif
            </div>
            @endif
                       ...
                       @endphp 
                        ...
                        <div class="my-2" >
                            <div class="d-flex justify-content-between">
                                ...
                                <i class="fa-solid fa-info charges-icon"></i>
                                </a></span>
                                @endif
                                </div>
                        ...
                        <div class="my-2" >
                            <div class="d-flex justify-content-between " >
                                ...
                                <div>Delivery charge
                                    ...
                                    <i class="fa-solid fa-info charges-icon"></i></a>
                                    </span>
                                     @endif
                                </div>
                        ...
                        <div class="last_summary_session_div">
                            ...
                            <div class="d-flex justify-content-between"><div>Coupan Code</div>
                            ...
                            <div class="d-flex justify-content-between">
                            <div>Applied Coupan Code</div><div class="font-weight-bold sm-summary"><span id="frequency_summary_promo_code_name_replace"></span></div>
                            </div>
                            @endif
                        </div>
                ...
                <input type="hidden" name="cleaner_id" id="cleaner_id" value="1">
            ...
            <div class="column">
             <div class="summary_div_left_new">
                ...
                <div class="d-flex justify-content-between"><div class="font-weight-bold sm-summary" style="margin-left:212px; margin-top:-30px;"> <span id="date_replace"></span> <span id="time_replace"></span></div></div>

                <div class="font-weight-bold-summary h5">Address</div>
                <div class="d-flex justify-content-between"><div class="font-weight-bold sm-summary" style="margin-left:265px; margin-top:-30px;"> <span id="address_replace"></span></div></div>
                <span class="underline"></span>
                ...
                <div class="d-flex justify-content-between">
                <div>Applied Coupan Code</div><div class="font-weight-bold sm-summary"><span id="promo_code_name_replace_home"></span></div>
                </div>
                </div>
                ...
                <div class="d-flex justify-content-between">
                <div>Applied Coupan Code</div><div class="font-weight-bold sm-summary"><span id="promo_code_name_replace"></span></div>
                </div>
                @endif
        ...
        <div class="summary_div_left_mobile" id="summary_div_left_mobile" style="display: none;">
            ...
            <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="d-flex justify-content-between"><div>Additional Charges
                    @if($subservice_popup_data->additional_charge_popup != "") 
                    <span>
                    <a style="cursor: pointer;" data-bs-toggle="modal" id="cleaner_stay" data-bs-target="#additional_charge_popup_{{$subservice_id}}">
                        <i class="fa-solid fa-info charges-icon"></i></a>
                ...
                <div class="font-weight-bold sm-summary"> AED <span id="additional_charge_replace_mobile"></span></div></div>
                ...
                <div class="mobile_last_summary_session_div">
                    ...
                    <div class="d-flex justify-content-between">
                    <div>Applied Coupan Code</div><div class="font-weight-bold sm-summary"><span id="mobile_promo_code_name_replace"></span></div>
                    </div>
                    @endif
                </div>
...
<div class="modal fade" id="material_{{$subservice_id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
  ...
  <!--- Service Fee Popup Start ---->
    ...
    <div class="modal fade" id="service_fee_popup_{{$subservice_id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg service-fee-custome-modal" id="modal-digi" role="document">
        <div class="modal-content">
            <div class="modal-header" style="display:block;">
            <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="background-color: #0040E6; color:#fff;">Close</button>
            {{-- <button type="button" class="btn btn-primary">Save changes</button> --}}
            </div>
        </div>
        </div>
...
<!--- Additional Charge Popup Start ---->
    ...
    <div class="modal fade" id="additional_charge_popup_{{$subservice_id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg service-fee-custome-modal" id="modal-digi" role="document">
        <div class="modal-content">
            <div class="modal-header" style="display:block;">
            <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
...
<!--- Delivery Charge Popup Start ---->
    ...
    <div class="modal fade" id="delivery_charge_popup_{{$subservice_id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg service-fee-custome-modal" id="modal-digi" role="document">
        <div class="modal-content">
            <div class="modal-header" style="display:block;">
            <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
...
<!--- Timing Fee Popup Start ---->
    ...
    <div class="modal fade" id="timing_fee_popup_{{$subservice_id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg service-fee-custome-modal" id="modal-digi" role="document">
        <div class="modal-content">
            <div class="modal-header" style="display:block;">
            <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
...
<div class="modal fade cleaners-modal" id="cleaner_description_{{$data->id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" id="modal-digi" role="document" style="max-width: 50%;">
      <div class="modal-content">
        <div class="modal-header" style="display:block;">
         <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
...
<div class="modal fade furniture-modal" id="material_furniture_{{$package_data->id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" id="modal-digi" role="document">
      <div class="modal-content">
        <div class="modal-header" style="display:block;">
         <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
...
$subservice_data = DB::table('subservices')
                ...
                ->first();
@endphp
<div class="modal fade furniture-modal" id="subservice_popup_{{$subservice_data->id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" id="modal-digi" role="document">
      <div class="modal-content">
        <div class="modal-header" style="display:block;">
         <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
        ...
        $.ajax({
            ...
            success: function(msg) {
                ...
                if (coupanData && coupanData.discount !== '' && coupanData.coupanvalue == 0) {
                    ...
                    var crossprice_new = parseInt(sub_total) + parseFloat(discount_amount) + 
...
function date_select() {
    ...
    if (cleaner_id != 1) {
        $.ajax({
            ...
            success: function(response) {
                // alert(response);
                if (response.timeslot.length > 0) {
                    var booked_slots = response.timeslot; 
                    var slots = $('input[name="time_slot"]');
                    var hours = response.hours;

                    booked_slots.forEach(function(slot, index) {
                        var slotValue = slot.toString();
                        var disableHours = parseInt(hours[index], 10); 
                        ...
                        slots.each(function(i) {
                            if ($(this).val() === slotValue) {
                                ...
                                // Disable the next 'disableHours' slots
                                for (var j = 1; j <= disableHours; j++) {
                                    var nextSlot = slots.eq(i + j);
                                    if (nextSlot.length) {
    ...
    function get_hide_show(id){
        ...
        if(id == 5){
           ...
           var promo_discount = $('#promo_discount').val(); 
            ...
            var crossprice = parseFloat(sub_total) + parseFloat(vat_charge) + parseFloat(promo_discount);
...
function apply_promo() {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (result === 'invalid') {
                if (isMobile) {
                    $("#mobile_promo_code_error").html("Invalid Coupan Code.");
                    $('#mobile_promo_code_error').show().delay(2000).fadeOut('show');
                    $("#mobile_promo_code_success").html("");
                } else {
                    $("#promo_code_error").html("Invalid Coupan Code.");
                    $('#promo_code_error').show().delay(2000).fadeOut('show');
                    $("#promo_code_success").html("");
                }
            }else if (result === 'invalid_date') {
                if (isMobile) {
                    $("#mobile_promo_code_error").html("Coupan Code Expired.");
                    $('#mobile_promo_code_error').show().delay(2000).fadeOut('show');
                    $("#mobile_promo_code_success").html("");
                } else {
                    $("#promo_code_error").html("Coupan Code Expired.");
                    $('#promo_code_error').show().delay(2000).fadeOut('show');
                    $("#promo_code_success").html("");
                }
                ...
                if (isMobile) {
                    $("#mobile_promo_code_error").html("Coupan Code is Already Applied.");
                    $('#mobile_promo_code_error').show().delay(2000).fadeOut('show');
                    $("#mobile_promo_code_success").html("");
                } else {
                    $("#promo_code_error").html("Coupan Code is Already Applied.");
                    $('#promo_code_error').show().delay(2000).fadeOut('show');
                    $("#promo_code_success").html("");
                }
            ...
            if (isMobile) {
                ...
                $("#mobile_promo_code_success").html("Coupan Code Applied Successfully.");
                ...
                if (isMobile) {
                    $("#mobile_promo_code_error").html("Coupan Code Value Greater Than Your Total.");
                    $('#mobile_promo_code_error').show().delay(2000).fadeOut('show');
                } else {
                    $("#promo_code_error").html("Coupan Code Value Greater Than Your Total.");
                    $('#promo_code_error').show().delay(2000).fadeOut('show');
                }
            } else {
                if (isMobile) {
...
var answer = window.confirm("Do you want to remove this Coupan Code?");
if (answer) {
...
$.ajax({
    ...
    success: function(result) {
        ...
        // Handle response
        if (result === 'invalid') {
            $("#frequency_summary_promo_code_error").html("Invalid Coupan Code.");
            $('#frequency_summary_promo_code_error').show().delay(2000).fadeOut('show');
            $("#frequency_summary_promo_code_success").html("");
        }else if (result === 'invalid_date') {
            $("#frequency_summary_promo_code_error").html("Coupan Code Expired.");
            $('#frequency_summary_promo_code_error').show().delay(2000).fadeOut('show');
            $("#frequency_summary_promo_code_success").html("");
         } else if (result === 'invalid_user_count') {
            $("#frequency_summary_promo_code_error").html("Coupan Code Expired.");
            ...
            $("#frequency_summary_promo_code_success").html("Coupan Code Applied Successfully.");
            ...
            if ($(window).width() >= 768) {
                ...
                $("#frequency_summary_promo_code_error").html("Coupan Code Value Greater Than Your Total.");
                $('#frequency_summary_promo_code_error').show().delay(2000).fadeOut('show');
                } 
                else {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (result === 'invalid') {
                ...
                $("#frequency_summary_promo_code_error").html("Coupan Code is Already Applied.");
                $('#frequency_summary_promo_code_error').show().delay(2000).fadeOut('show');
                $("#frequency_summary_promo_code_success").html("");
            } else if (result === 'success') {
