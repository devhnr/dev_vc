...
.para1{margin-bottom: inherit !important;}
</style>
                        ...
                        <div class="tab3">
                            ...
                            <div class="container text-center">
								...
								<i class="fa-solid fa-check" style="font-size: 40px;margin: 0 0 3px 4px;"></i>
                                    ...
                                    <p class="textp para1">You will receive <b>up to 5 quotes  </b> from our trusted vendors within the next <b>2 business days.</b></p>
                                    <p class="textp">A detailed confirmation email has been sent to your email address with further details.</p>
                                    <p class="textp">Each quote will include detailed pricing and service information. You can review the quotes and select the one that best meets your needs based on their rating and review.</p>
