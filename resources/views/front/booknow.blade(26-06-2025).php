...
<section class="our-register">
    ...
    <p class="form-error-text" id="cleaner_error" style="color: red; margin-top: 10px;"></p>
            ...
            <button id="stickyButton" class="booking-summary" style="bottom:17px;margin-bottom: 10px;">
            ...
            <div class="column">
             <div class="summary_div_left_new">
                ...
                <div class="d-flex justify-content-between"><div class="font-weight-bold sm-summary" style="margin-left:183px; margin-top:-30px;"> <span id="date_replace"></span></br><span id="time_replace"></span></div></div>
