    ...
    <ul class="splide__list">
      ...
      <li class="splide__slide text-center" >
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/Cleaning-01-01.png') }}" alt="">
            </div>
            </div>
          <div class="details">
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/Moving-01.png') }}" alt="">
            </div>
            </div>
          <div class="details">
            <p class="title mt10 mb-3 subservice-title">Moving</p>
          </div>
        </div>
      </li>
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/Spa-01.png') }}" alt="">
            </div>
          </div>
          <div class="details">
            <p class="title mt10 mb-3 subservice-title">Salon & Spa</p>
          </div>
        </div>
      </li>
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/Storage-01.png') }}" alt="">
            </div>  
          </div>
          <div class="details">
            <p class="title mt10 mb-3 subservice-title">Storage</p>
          </div>
        </div>
      </li>
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/Pest Contril-01.png') }}" alt="">
            </div>  
          </div>
          <div class="details">
            <p class="title mt10 mb-3 subservice-title">Pest Control & Gardening</p>
          </div>
        </div>
      </li>
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/Handyman-01.png') }}" alt="">
            </div>  
          </div>
          <div class="details">
            <p class="title mt10 mb-3 subservice-title">Handyman & Maintenance</p>
          </div>
        </div>
      </li>
