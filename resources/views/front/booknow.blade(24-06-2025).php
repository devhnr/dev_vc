            ...
            @endif
                ...
                <div class="form-group mb-3">
                   ...
                   <div class="form-group mb-3">
                    ...
                    <p><span style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#cancel_policy_{{ $subservice_id }}"> 
                        <img src="{{ asset('public/site/images/infoicon.svg') }}" style="height: 15px;width: 15px;"></span> 
...
<div class="modal modal-mobile-bottom" id="material_{{$subservice_id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
  ...
  <!--- Service Fee Popup Start ---->
    ...
    <div class="modal modal-mobile-bottom" id="service_fee_popup_{{$subservice_id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-bottom modal-lg service-fee-custome-modal" id="modal-digi" role="document">
        <div class="modal-content">
...
<div class="modal modal-mobile-bottom cleaners-modal" id="cleaner_description_{{$data->id}}"  tabindex="-1" aria-labelledby="materialTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-bottom modal-lg" id="modal-digi" role="document" style="max-width: 50%;">
      <div class="modal-content">
        <div class="modal-header" style="display:block;">
         <button type="button" class="close closeBtn" id="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
...
// alert(coupan_value);
    ...
    function get_hide_show(id){
        ...
        if($subservice_id == 29 || $subservice_id == 70 || $subservice_id == 71 || 
            ...
            $(".step-title .back-icon")
                .css("cursor", "pointer")
                .off("click") // Unbind old handlers to prevent duplication
                .on("click", function () {
                    get_hide_show(1); // Same as Previous button
                });
              } else {
        ...
        if(id == 3){
         ...
         if (window.innerWidth <= 767) {
            ...
            $(".step-title .back-icon")
                ...
                .off("click") // Unbind old handlers to prevent duplication
                .on("click", function () {
                    get_hide_show(2); // Same as Previous button
                });
              } else {
            $(".step-title .back-icon").empty();
            }
        ...
        if(id == 4){
            ...
            $(".step-title .back-icon")
                ...
                .off("click") // Unbind old handlers to prevent duplication
                .on("click", function () {
                    get_hide_show(3); // Same as Previous button
                });
              } else {
            $(".step-title .back-icon").empty();
            }
