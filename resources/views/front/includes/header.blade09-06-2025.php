            ...
            <nav class="posr">
                <div class="container posr menu_bdrt1">
                    <div class="row align-items-center justify-content-between">
                                    ...
                                    <div id="mega-menu" class="mega-menu-custom dropdown">
                                        ...
                                        <div id="myDropdownnew" class="dropdown-content-new">
                                            ...
                                            <div class="row">
                                                ...
                                                <ul>
                                                 <li><h6><a href="{{ url('service/pest-control-and-gardening')}}">Pest Control and Gardening</a></h6></li>
                                                @php
                                                    $subservice_data = DB::table('subservices')
                                                        ->where('serviceid', 47)
                                                        ->where('is_active', 0)
                        ...
                        <div class="col-auto px-0 head_search_sticky" style="width: 30%;position: relative;{{$style_div_head}}">
                            <div
