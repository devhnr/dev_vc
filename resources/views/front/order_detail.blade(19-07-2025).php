                ...
                <div class="col-lg-8">
                    ...
                    <div>
                        ...
                        <span class="text-primary fw-bold">
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ConfirmModal" class="text-primary showMore"  style="color: {{ $statusColor }} !important;">{{$statusText}} ></a>
                        </span>
                        ...
                        @endphp
                        <span class="text-primary fw-bold">
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#CompleteModal" class="text-primary showMore"  style="color: {{ $statusColor }} !important;">{{$statusText}} ></a>
                        </span>
        ...
        <div class="edit_booking_popup">
           ...
           <div class="edit_booking_popup">
            <ul class="list-unstyled mb-3">
                <div class="option-row-receipt">
                    <li>
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#Edit_reschedule_Modal" class="d-flex align-items-center justify-content-between text-decoration-none text-muted">
                        <div class="option-label">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="text-center">
        <input type="button" class="btn btn-danger white-text" id="cancel_order_btn" value="Cancel">
