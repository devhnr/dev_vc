                ...
                <div class="advance-search-tab bgc-white p10 bdrs4-sm bdrs60 banner-btn mt20 mb20 mx-auto" style="max-width: 700px;">
                    <form action="{{ url('search-package') }}" method="get" id="search_banner">
                        ...
                        <div class="row justify-content-center align-items-center g-2">
                            ...
                            {{-- <button type="submit" style="padding: 0 25px 0 25px;border-radius: 30px; color:#fff;background-color:#0040E6">Search</button> --}}
                        </div>
                    </form>
                </div>
    ...
    <ul class="splide__list">
      ...
      <li class="splide__slide text-center" >
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/cleaning_icon.png') }}" alt="">
            </div>
            </div>
          <div class="details">
            <p class="title mb-3 subservice-title">Cleaning</p>
          </div>
        </div>
      </li>
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/moving_icon.png') }}" alt="">
            </div>
            </div>
          <div class="details">
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/spa_salon_icon.png') }}" alt="">
            </div>
          </div>
          <div class="details">
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/storage_icon.png') }}" alt="">
            </div>  
          </div>
          <div class="details">
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/pest_control_icon.png') }}" alt="">
            </div>  
          </div>
          <div class="details">
      ...
      <li class="splide__slide text-center">
        <div class="iconbox-style1 border-less p-0">
          <div class="icon before-none">
            <div class="details">
                <img class="bdrs20" src="{{ asset('public/site/images/Homepage/subservice_logo/handyman_icon.png') }}" alt="">
            </div>  
          </div>
          <div class="details">
            ...
            @if ($subservice_data != '' && count($subservice_data) > 0)
                <div class="container">
                    <div class="row align-items-center wow fadeInUp" data-wow-delay="00ms">
                        <div class="col-7 col-lg-9 service-slider">
                        ...
                        @if ($subservice_data != '')
                        <div id="splide_{{$service_data->id}}" class="splide mobile-splide row wow fadeInUp main-title" data-wow-delay="300ms" data-subservice-count="{{ $subservice_count }}">
                            <div class="splide__track">
                                <ul class="splide__list">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-7 offset-xl-5 wow fadeInUp" data-wow-delay="200ms">
            <div class="main-title">
              <h2 class="title text-capitalize">We do the work, so that you can chill.</h2>
...
<div class="container we-do-slider-mobile" style="display:none;" >
        <div class="row align-items-center wow fadeInUp">
          <div class="col-lg-9">
            <div class="main-title">
              <h2 class="title">We do the work, so that you can chill.</h2>
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
          <div class="col-lg-12">
            <div class="vam_nav_style dots_none owl-carousel owl-theme we-do-mobile-slider">
              <div class="item">
                <div class="freelancer-style1 text-center bdr1 bdrs16 hover-box-shadow">
                  ...
                  <div class="details">
                    <h5 class="title mb-1">Find your required service</h5>
                    <p class="mb-0">Choose from 50+ services, 100+ vendors, same-day slots, live support, easy booking</p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="freelancer-style1 text-center bdr1 bdrs16 hover-box-shadow">
                  ...
                  <div class="details">
                    <h5 class="title mb-1">Book your Service in Minutes</h5>
                    <p class="mb-0">Secure pay, easy cancel, flexible slots, free quotes, managed packages.</p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="freelancer-style1 text-center bdr1 bdrs16 hover-box-shadow">
                  ...
                  <div class="details">
                    <h5 class="title mb-1">Relax & Let Us Handle the Work</h5>
                    <p class="mb-0">100% satisfaction, referral rewards,no hidden fees, quality checks, and personalized services</p>
                  </div>
                </div>
              </div>
            </div>
