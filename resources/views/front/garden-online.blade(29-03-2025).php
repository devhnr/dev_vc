    ...
    <div class="container">
        ...
        <div class="col-lg-6">
            ...
            @endif
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="radio-group size-of-home-tab1 owl-carousel owl-theme slider" id="live-type-slider" style="display: inline-flex;">  
                            ...
                            <div class="hour_input items">
                                <input type="radio" id="type-of-home-1" name="type_of_home" value="Apartment" onclick="type_of_homeGarden(this.value);">
                                <label for="type-of-home-1">Apartment</label>
                            </div>
                    
                            <div class="hour_input items">
                                <input type="radio" id="type-of-home-2" name="type_of_home" value="Villa" onclick="type_of_homeGarden(this.value);">
                                <label for="type-of-home-2">Villa</label>
                            </div>

                            @if($subservice_id == 77)
                            <div class="hour_input items">
                                <input type="radio" id="type-of-home-5" name="type_of_home" value="Warehouse" onclick="type_of_homeGarden(this.value);">
                                <label for="type-of-home-5">Warehouse</label>
                            </div>
                            @endif

                            <div class="hour_input items">
                                <input type="radio" id="type-of-home-3" name="type_of_home" value="Office"" onclick="type_of_homeGarden(this.value);">
                                <label for="type-of-home-3">Office</label>
                            </div>

                            <div class="hour_input items">
                                <input type="radio" id="type-of-home-4" name="type_of_home" value="Other" onclick="type_of_homeGarden(this.value);">
                                <label for="type-of-home-4">Other</label>
                            </div>
                        </div>
                        <p style="color:red;" id="type_of_home_error"></p>
                    </div>

                    <div class="form-group garden-home-div" style="display: none;">
                        <label class="form-label fw500 dark-color"
                        ...
                        <div class="radio-group size-of-home-tab1 owl-carousel owl-theme slider" id="size-of-home-slider" style="display: inline-flex;">
                            ...
                            <div class="hour_input items">
                                <input type="radio" id="size-of-home-studio-{{ $count }}" name="size_of_home_1" value="{{ $apartmentPrice->id }}">
                    ...
                    <div class="form-group garden-villa-div" style="display: none;">
                        <label class="form-label fw500 dark-color"
                        for="country">What is the size of your home?</label><br>
                        <div class="radio-group size-of-home-tab1 owl-carousel owl-theme slider" id="size-of-villa-slider" style="display: inline-flex;">
                            ...
                            <div class="hour_input items">
                                <input type="radio" id="size-of-home2-{{ $villa }}" name="size_of_home_1" value="{{ $villaPrice->id }}">
                    ...
                    <div class="form-group garden-warehouse-div" style="display: none;">
                        <label class="form-label fw500 dark-color"
                        for="country">What is the size of your Warehouse?</label><br>
                        <div class="radio-group size-of-home-tab1 owl-carousel owl-theme slider" id="size-of-warehouse-slider" style="display: inline-flex;">
                            ...
                            <div class="hour_input items">
                                <input type="radio" id="size-of-warehouse-{{ $warehouse }}" name="size_of_home_1" value="{{ $Warehouse->id }}">
                                <label for="size-of-warehouse-{{ $warehouse }}">{{ $Warehouse->size_of_home }}</label>
                                <p style="font-size: 9px; margin-left:14px;"></p>
                            </div>
                            @php
                                $warehouse++;
                ...
                <button class="btn btn-primary mb-1 book-now-web spinner_button" type="button" disabled id="spinner_button" style="display: none;">
                    ...
                    onclick="book_garden()">Book Now </button>
                </div>
...
function type_of_homeGarden(value) {
    // alert(value);    
        // Hide and reset both divs first
        $('.garden-home-div, .garden-villa-div').hide();
        $('.garden-home-div, .garden-warehouse-div').hide();
        $('.garden-home-div input[type="radio"], .garden-villa-div input[type="radio"]').prop('checked', false);

        // Show the correct div based on selection
        if (value == "Apartment") {
            $('.garden-home-div').show();
        }else if(value == "Villa") {
            $('.garden-villa-div').show();
        }else if(value == "Warehouse") {
            $('.garden-warehouse-div').show();
        }
    }
...
function validateTypeOfHome() {
    var type_of_home = document.getElementsByName('type_of_home');
    var selected = false;

    // Loop through radio buttons to check if one is selected
    for (var i = 0; i < type_of_home.length; i++) {
        if (type_of_home[i].checked) {
            selected = true;
            break;
        }
    }
    if (type_of_home === "Apartment" || type_of_home === "Villa") {
        validateSizeOfHome();
    }
