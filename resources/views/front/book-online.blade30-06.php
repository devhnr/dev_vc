    ...
    <div class="container">
        ...
        <div class="col-lg-7">
            ...
            @endif
                ...
                <div class="d-flex justify-content-between"><div class="font-weight-bold sm-summary" style="margin-left: 177px; margin-top:-30px;"> <span id="date_replace"></span></br><span id="time_replace"></span></div></div>  
...
<div class="modal modal-mobile-bottom" id="exampleModalLong_{{$subservice_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div id="modal-digi" class="modal-dialog modal-dialog-bottom" role="document" style="">
