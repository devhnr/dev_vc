...
class checkoutcontroller extends Controller
{
	...
	public function payment_success(Request $request){
		...
		/* echo "<pre>";print_r($stripe_session_id);echo"</pre>";
 ...
 <style>
     ...
     public function success_mail_book_now(){
        ...
        if($order_item_data->which_day_of_the_week_do_you_want_the_service != ''){
            $when = $order_item_data->which_day_of_the_week_do_you_want_the_service." " .$order_item_data->bookingdate . " ".$order_item_data->month. ", " .$order_item_data->bookingyear;
        }else{
...
<div class="wrapper" style="width: 100%;max-width:500px;margin:auto;
    ...
    <img src="'.asset("public/site/images/VC-FULL-COLOR.png").'"" style="width: 40%;" >
     ...
     <div class="email_wrapper" style="width:100%;margin-top: 18px;font-size: 16px;" >
                       ...
                       <div class="heading" style="font-weight: bold;font-size: 20px;margin-top: 7%;">Here are the details of your service:</div>
                       <hr>
                       <div class="main">
