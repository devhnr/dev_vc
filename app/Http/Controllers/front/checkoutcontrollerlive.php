                       ...
                       <div class="main">
                            <div class="row main_row" style="margin:10px 0;">
                             ...
                             <div class="row main_row" style="margin:10px 0;">
                                ...
                                display: inline-block;">
                                <ul style="margin: 0;padding: 0"><li>
                                    <h5 style="font-size: 14px;margin: 0;">Date: <span style="margin: 0;font-weight:100;"> '.$date_and_time.' </span></h5>
                                    </li></ul>
                                </div>
                             </div>
                             ...
                             <div class="row main_row" style="margin:10px 0;">
                                ...
                                <ul style="margin: 0;padding: 0"><li>
                                    <h5 style="font-size: 14px;margin: 0;">Time: 
                                     <span style="margin: 0;font-weight:100;"> '.$timeSlot.'</span></h5> </li></ul>
                                </div>
                             </div>
                             ...
                             <div class="row main_row" style="margin:10px 0;">
                                ...
                                <ul style="margin: 0;padding: 0"><li>
                                    <h5 style="font-size: 14px;margin: 0;">Service: 
                                     <span style="margin: 0;font-weight:100;"> '.$order_item_data->type_of_painting.'</span></h5> </li></ul>
                                </div>
                             </div>
                             ...
                             <div class="row main_row" style="margin:10px 0;">
                                ...
                                <ul style="margin: 0;padding: 0"><li>
                                    <h5 style="font-size: 14px;margin: 0;">Size of Home: 
                                     <span style="margin: 0;font-weight:100;"> '.$order_item_data->selected_type_home.' - '.$order_item_data->selected_size_home.'</span></h5> </li></ul>
                                </div>
                             </div>
                             ...
                             <div class="row main_row" style="margin:10px 0;">
                                ...
                                <ul style="margin: 0;padding: 0"><li>
                                    <h5 style="font-size: 14px;margin: 0;">Furnished:
                                     <span style="margin: 0;font-weight:100;"> '.$order_item_data->is_home_furnished.'</span></h5> </li></ul>
                                </div>
                             </div>
                             ...
                             <div class="row main_row" style="margin:10px 0;">
                                ...
                                display: inline-block;">
                                <ul style="margin: 0;padding: 0"><li>
                                    <h5 style="font-size: 14px;margin: 0;">Colors:
                                     <span style="margin: 0;font-weight:100;"> '.$order_item_data->your_walls_now_color.' to '.$order_item_data->you_want_paint_color.'</span></h5> </li></ul>
                                </div>
                             </div>';
                             ...
                             if($order_item_data->no_of_ceilings !=""){
                                ...
                                $message_bodyy .= '<div class="row main_row" style="margin:10px 0;">
                                    ...
                                    <ul style="margin: 0;padding: 0"><li>
                                        ...
                                        <span style="margin: 0;font-weight:100;"> '.$order_item_data->no_of_ceilings.'</span></h5> </li></ul>
                                    </div>
                                </div>';
                             }
                             ...
                             $message_bodyy .= '<div class="row main_row" style="margin:10px 0;">
                                    ...
                                    <ul style="margin: 0;padding: 0"><li>
                                        <h5 style="font-size: 14px;margin: 0;">Address:
                                        <span style="margin: 0;font-weight:100;"> '.$address_painting.'</span></h5> </li></ul>
                                    </div>
                                </div>';
