...
class VendorOrderController extends Controller
{
    ...
    public function index($order_id = '', $status = '')
    {
        ...
        ->select('frontloginregisters.email as user_email', 'frontloginregisters.name as user_name', 'frontloginregisters.mobile as user_mobile',  'ci_orders.*')->where('ci_orders.order_from', '!=', 2);
